...
do {
    ...
    switch ($action) {
        ...
        '2' {
            Invoke-Command -ComputerName $selectedServer -ScriptBlock $InstallWindowsUpdatesForeground
        }
        '3' {
            Invoke-Command -ComputerName $selectedServer -ScriptBlock $InstallWindowsUpdatesBackground
        }
        '4' {
        ...
        '61' {
            Invoke-Command -ComputerName $selectedServer -ScriptBlock $ExchangeHealthChecker
        }
        '62' {
            Invoke-Command -ComputerName $selectedServer -ScriptBlock $ExchangeQueue
        }
        '81' {
            Invoke-Command -ComputerName $selectedServer -ScriptBlock $ScheduledRestart
        }
        '82' {
            Invoke-Command -ComputerName $selectedServer -ScriptBlock $AutomaticServiceTask
        }
        '9' {
